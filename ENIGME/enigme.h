...
void afficherEnigme(enigme e, SDL_Surface* screen); // l fonction li taffichi kolchay
...
void interface_win(SDL_Surface* screen, int* boucle, enigme e); // fonction tassuri l'affichage mtaa l background win 
void interface_lose(SDL_Surface* screen, int* boucle, enigme e); // fonction tassuri l'affichage mtaa l background lose
